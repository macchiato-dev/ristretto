...
Here are the files for building it.

For the build, a docker container with node and Deno will be used.

- use `FROM` to pull in distroless deno
- base on `node:bookworm-slim`
- copy deno from distroless container
...
```json
{
  ...
  "packages": {
    ...
    "node_modules/@rollup/browser": {
      "version": "4.5.1",
      "resolved": "https://registry.npmjs.org/@rollup/browser/-/browser-4.5.1.tgz",
      "integrity": "sha512-c/t1xncm72i+/0+fCqdjgyKGdYzVuu5V2yDY8dfcvB7mIExePjDvHeI6AYkukrYtsV8HpnSC86dAmnPzG93s9g=="
    },
    "node_modules/crelt": {
      "version": "1.0.6",
